...
/*
 take i and k , initialize it with zero.Now scan through the array, if we found
 non zero element ,swap it with k index and increase the k by one.
 if we find zero , we simply increase i by one.
*/
